...
const trophy = (
  <svg className={styles.trophy} width="22" height="22" viewBox="0 0 24 24" fill="#FFC107" xmlns="http://www.w3.org/2000/svg" style={{ verticalAlign: 'middle', filter: 'drop-shadow(0 1px 2px #FFB30088)' }}>
...
const ClaimButton = ({ onClaim, disabled, loading }) => (
  <button
